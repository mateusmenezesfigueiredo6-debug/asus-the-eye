...
Role emphasis:
Focus on LGPD, privacy, decision-maker analytics limits, secrets, least privilege, threat modeling, audit ledger, Merkle proofs, blockchain anchoring, and prohibition of personal data on-chain.
