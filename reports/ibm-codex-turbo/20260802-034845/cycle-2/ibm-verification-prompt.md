...
Role emphasis:
Focus on tests, evidence quality, reproducibility, contradictions, completion criteria, failure recovery, data quality, source citations, and whether claimed work is actually present in files and logs.
