...
def graph_built_event(
    snapshot: dict[str, Any], commit: str, tenant_id: str = DEFAULT_TENANT
) -> dict:
...
def ranking_published_event(
    ranking_list: dict[str, Any], tenant_id: str = DEFAULT_TENANT
) -> dict:
