            ...
            with self.connection:
                ...
                self.connection.execute(
                    ...
                    (
                        ...
                        event["event_type"],
                        event["resource_type"],
                        event["resource_id_pseudonymous"],
                        event["recorded_at"],
                        event["event_hash_sha256"],
                        event["previous_event_hash_sha256"],
                        serialized,
                    ),
                )
                self.connection.execute(
    ...
    def record(
        ...
        **values: Any,
        ...
        body: dict[str, Any] = {
            ...
            "action": action,
            "occurred_at": values.pop("occurred_at", now),
            "recorded_at": now,
            ...
            "resource_version": values.pop("resource_version", "1"),
            "jurisdiction": values.pop("jurisdiction", "BR"),
            ...
            "causation_id": values.pop("causation_id", None),
            "model_provider": values.pop("model_provider", None),
            "model_name": values.pop("model_name", None),
            "model_version": values.pop("model_version", None),
            ...
            "result_status": values.pop("result_status", "success"),
            "error_code": values.pop("error_code", None),
            "created_by_service": self.service,
